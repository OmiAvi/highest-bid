...
export function ResultsPage() {
    ...
    return (_jsx("div", { style: pg.page, children: _jsxs("div", { style: pg.content, children: [_jsxs("div", { style: pg.header, children: [_jsxs("div", { style: pg.headerTop, children: [_jsx(GavelIcon, { size: 22, glow: true }), _jsx("span", { style: pg.logoText, children: "Highest Bid" }), _jsxs("span", { style: { fontSize: 11, color: "var(--white-dim)", marginLeft: 8 }, children: ["Game #", gameId] })] }), _jsx("div", { style: pg.resultBanner, children: winner
...
const pg = {
    ...
    scoreLine: { fontFamily: "var(--font-d)", fontSize: "clamp(28px, 7vw, 40px)", fontWeight: 700, lineHeight: 1, whiteSpace: "nowrap" },
    card: {
