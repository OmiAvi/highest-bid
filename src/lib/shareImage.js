...
function trimLabel(value, max = 20) {
...
function rosterMarkup(slots, x, y, color) {
...
function seriesMarkup(series, p1Name, p2Name) {
...
export async function createResultsShareImage(state, series, siteUrl) {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}">
    ...
    try {
        ...
        if (!pngBlob)
            throw new Error("Failed to export share image");
