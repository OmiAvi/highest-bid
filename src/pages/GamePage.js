...
export function GamePage() {
    ...
    async function handleRaise(e) {
        ...
        if (!session || !poll || actionPending)
            return;
        const gs = poll.state;
        const myNum = session.mode === "local"
            ? gs.biddingTurn
        ...
        try {
            ...
            if (session.mode === "local")
                setPoll(await pollGame(gameId, session.token));
            setBidInput("");
        }
        catch (e) {
    ...
    async function handleAssignSlot(position) {
        if (!session || !poll || actionPending)
            return;
        setActionPending(true);
        setActionError("");
    ...
    const myNum = isLocal ? gs.biddingTurn : (poll.myRole ?? (session.role === "p1" ? 1 : 2));
    ...
    return (_jsxs("div", { style: s.layout, children: [_jsx("aside", { style: s.sidebar, className: "desktop-sidebar", children: _jsxs("div", { style: s.sideInner, children: [_jsxs("div", { style: s.sideHeader, children: [_jsx(GavelIcon, { size: 20, glow: true }), _jsx("span", { style: s.logoText, children: "Highest Bid" })] }), _jsx("div", { style: s.sideLabel, children: "Rosters" }), _jsx(RosterPanel, { name: gs.p1Name, slots: gs.roster1, budget: gs.p1Budget, num: 1 }), _jsx(RosterPanel, { name: gs.p2Name, slots: gs.roster2, budget: gs.p2Budget, num: 2 })] }) }), rosterOpen && (_jsx("div", { style: s.overlay, onClick: () => setRosterOpen(false), children: _jsxs("div", { style: s.drawer, onClick: e => e.stopPropagation(), children: [_jsx("button", { style: s.drawerClose, onClick: () => setRosterOpen(false), children: "Close" }), _jsx("div", { style: s.sideLabel, children: "Rosters" }), _jsx(RosterPanel, { name: gs.p1Name, slots: gs.roster1, budget: gs.p1Budget, num: 1 }), _jsx(RosterPanel, { name: gs.p2Name, slots: gs.roster2, budget: gs.p2Budget, num: 2 })] }) })), _jsxs("main", { style: s.main, children: [_jsxs("div", { style: s.topbar, children: [_jsx("div", { style: s.topLeft, children: gs.phase === "waiting"
                                    ? _jsx("span", { style: s.roundLabel, children: "Waiting room" })
                                    : _jsxs(_Fragment, { children: [_jsxs("span", { style: s.roundLabel, children: ["Round ", gs.round] }), _jsx("span", { style: s.roundDot }), _jsx("span", { style: { fontSize: 12, color: isMyTurn && gs.phase === "bidding" ? myColor : "var(--white-dim)" }, children: gs.phase === "bidding"
                                                    ? (isLocal ? `${currentTurnName}'s turn` : (isMyTurn ? "Your turn" : "Opponent's turn"))
                                                    : gs.phase === "reveal" ? "Reveal" : "" })] }) }), _jsxs("div", { style: s.topRight, children: [gs.phase !== "waiting" && (_jsxs("div", { style: s.budgetRow, children: [_jsx(BudgetChip, { name: gs.p1Name, budget: gs.p1Budget, color: "var(--gold)", isMe: !isLocal && myNum === 1 }), _jsx("span", { style: { color: "var(--border-strong)", fontSize: 12 }, children: "\u00B7" }), _jsx(BudgetChip, { name: gs.p2Name, budget: gs.p2Budget, color: "var(--accent)", isMe: !isLocal && myNum === 2 })] })), _jsx("button", { className: "mobile-roster-toggle", style: s.rosterToggle, onClick: () => setRosterOpen(true), children: "Roster" })] })] }), gs.phase === "waiting" && (_jsx("div", { style: { animation: "fadeUp 0.3s ease-out" }, children: _jsxs("div", { style: s.waitingCard, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, color: "var(--white-dim)", letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 16 }, children: "Share this code" }), _jsxs("div", { style: s.joinCodeDisplay, onClick: copyCode, children: [_jsx("span", { style: s.joinCodeText, children: poll.joinCode }), _jsx("span", { style: { fontSize: 11, color: codeCopied ? "var(--gold)" : "var(--white-dim)", transition: "color 150ms" }, children: codeCopied ? "Copied" : "Click to copy" })] }), _jsxs("div", { style: { fontSize: 13, color: "var(--white-dim)", marginTop: 16, lineHeight: 1.6 }, children: ["Your opponent opens this site and clicks ", _jsx("strong", { style: { color: "var(--white)", fontWeight: 600 }, children: "Join with code" }), ". The game starts automatically."] })] }) })), gs.phase === "bidding" && gs.currentPlayer && (_jsxs("div", { style: { animation: "fadeUp 0.25s ease-out", display: "flex", flexDirection: "column", gap: 16 }, children: [_jsx(PlayerCard, { player: gs.currentPlayer, animKey: cardKey }), _jsx("div", { style: s.statusBar, children: gs.currentLeader ? (_jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 8 }, children: [_jsx("span", { style: s.currentBidAmount, children: fmt$(gs.currentBid) }), _jsxs("span", { style: { fontSize: 13, color: "var(--white-dim)" }, children: ["led by ", !isLocal && gs.currentLeader === myNum ? "you" : (gs.currentLeader === 1 ? gs.p1Name : gs.p2Name), gs.firstPassUsed ? " · opponent passed" : ""] })] })) : (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 16, fontWeight: 600, color: "var(--white-dim)" }, children: "No bids yet" }), gs.firstPassUsed && (_jsx("span", { style: s.pill, children: "Opponent passed" }))] })) }), isMyTurn && (_jsxs("form", { onSubmit: handleRaise, style: { ...s.panel, borderColor: `${myColor.replace("var(", "").replace(")", "")} 30` }, children: [_jsxs("div", { style: { borderLeft: `2px solid ${myColor === "var(--gold)" ? "var(--gold)" : "var(--accent)"}`, paddingLeft: 12, marginBottom: 16 }, children: [_jsx("div", { style: { fontFamily: "var(--font-d)", fontSize: 14, fontWeight: 600, color: "var(--white)" }, children: isLocal ? `${currentTurnName}'s turn` : "Your turn" }), _jsxs("div", { style: { fontSize: 12, color: "var(--white-dim)", marginTop: 2 }, children: ["Budget: ", fmt$(myBudget), " \u00B7 Max bid: ", fmt$(maxBid), gs.currentBid > 0 ? ` · min raise ${fmt$(minBid)}` : ""] })] }), canRaise && (_jsxs("div", { style: s.bidRow, children: [_jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 26, fontWeight: 600, color: myColor, lineHeight: 1 }, children: "$" }), _jsx("input", { type: "number", min: minBid, max: maxBid, step: "1", value: bidInput, onChange: e => { setBidInput(e.target.value); setActionError(""); }, placeholder: `${minBid}`, autoFocus: true, style: { ...s.bidInput, color: myColor } })] })), !canRaise && (_jsx("div", { style: { fontSize: 13, color: "#F87171", marginBottom: 12 }, children: "You must keep at least $1 for each remaining open slot, so you have to pass." })), actionError && _jsx("div", { style: s.errMsg, children: actionError }), _jsxs("div", { style: { display: "flex", gap: 10, marginTop: 6 }, children: [canRaise && (_jsx("button", { type: "submit", disabled: actionPending || !bidInput, style: {
                                                    ...s.btnRaise,
                                                    background: myNum === 1 ? "var(--gold)" : "var(--accent)",
                                                    opacity: actionPending || !bidInput ? 0.45 : 1,
                                                }, children: "Raise bid" })), _jsx("button", { type: "button", onClick: handlePass, disabled: actionPending, style: { ...s.btnPass, flex: canRaise ? "0 0 auto" : "1" }, title: passHint, children: "Pass" })] }), _jsx("div", { style: { fontSize: 12, color: "var(--white-dim)", marginTop: 10 }, children: passHint })] })), !isMyTurn && !isLocal && (_jsxs("div", { style: s.waitingTurnPanel, children: [_jsx("div", { style: s.spinnerSm }), _jsxs("div", { children: [_jsxs("div", { style: { fontFamily: "var(--font-d)", fontSize: 14, fontWeight: 600, color: "var(--white)" }, children: [gs.biddingTurn === 1 ? gs.p1Name : gs.p2Name, " is deciding"] }), _jsx("div", { style: { fontSize: 12, color: "var(--white-dim)", marginTop: 2 }, children: "They can raise or pass" })] })] })), gs.history.length > 0 && (_jsxs("div", { style: s.historyPanel, children: [_jsx("div", { style: s.sideLabel, children: "Recent" }), [...gs.history].reverse().slice(0, 3).map(h => (_jsxs("div", { style: s.historyRow, children: [_jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 14, fontWeight: 600 }, children: h.playerName }), _jsx("span", { style: { color: "var(--white-dim)" }, children: "\u00B7" }), h.winner ? (_jsxs("span", { style: { fontSize: 13, color: h.winner === 1 ? "var(--gold)" : "var(--accent)", fontWeight: 500 }, children: [h.winner === 1 ? gs.p1Name : gs.p2Name, " \u2014 ", fmt$(h.winningBid)] })) : (_jsx("span", { style: { fontSize: 13, color: "var(--white-dim)" }, children: "No winner" }))] }, h.id)))] }))] }, cardKey)), gs.phase === "reveal" && lr && (_jsxs("div", { style: { animation: "fadeUp 0.25s ease-out", display: "flex", flexDirection: "column", gap: 16 }, children: [_jsx(PlayerCard, { player: lr.player, animKey: -1 }), _jsxs("div", { style: s.revealGrid, children: [_jsx(RevealSide, { name: gs.p1Name, bid: lr.bid1, won: lr.winner === 1, color: "var(--gold)", isMe: !isLocal && myNum === 1 }), _jsx("div", { style: s.vsLabel, children: "vs" }), _jsx(RevealSide, { name: gs.p2Name, bid: lr.bid2, won: lr.winner === 2, color: "var(--accent)", isMe: !isLocal && myNum === 2 })] }), _jsx("div", { style: s.outcomePanel, children: lr.winner && lr.assignedSlot ? (_jsxs(_Fragment, { children: [_jsxs("span", { style: { fontFamily: "var(--font-d)", fontSize: 20, fontWeight: 700, color: lr.winner === 1 ? "var(--gold)" : "var(--accent)" }, children: [lr.winner === 1 ? gs.p1Name : gs.p2Name, " wins"] }), _jsx("span", { style: { fontSize: 12, color: "var(--white-dim)", marginLeft: 10 }, children: lr.slotFilled
                                                ...
                                                : `No roster slot left for ${lr.player.name}` })] })) : lr.winner ? (_jsxs("span", { style: { fontFamily: "var(--font-d)", fontSize: 18, fontWeight: 600, color: lr.winner === 1 ? "var(--gold)" : "var(--accent)" }, children: [lr.winner === 1 ? gs.p1Name : gs.p2Name, " wins the auction"] })) : (_jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 18, fontWeight: 600, color: "var(--white-dim)" }, children: "Both passed \u2014 player skipped" })) }), canChooseSlot && (_jsxs("div", { style: s.slotPicker, children: [_jsx("div", { style: { fontFamily: "var(--font-d)", fontSize: 15, fontWeight: 600, color: "var(--white)" }, children: "Choose a lineup slot" }), _jsx("div", { style: { fontSize: 12, color: "var(--white-dim)" }, children: "Pick the position and we'll place the rest of the lineup around it." }), _jsx("div", { style: s.slotGrid, children: placementOptions.map((option) => (_jsxs("button", { type: "button", onClick: () => handleAssignSlot(option.position), disabled: actionPending, style: s.slotButton, children: [_jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 15, fontWeight: 700, color: "var(--white)" }, children: option.position }), _jsx("span", { style: { fontFamily: "var(--font-d)", fontSize: 22, fontWeight: 700, color: option.overall >= 85 ? "var(--gold)" : "var(--white)" }, children: option.overall }), _jsx("span", { style: { fontSize: 11, color: "var(--white-dim)" }, children: option.outOfPosition ? `-${option.penalty} penalty` : "natural fit" })] }, option.position))) }), actionError && _jsx("div", { style: s.errMsg, children: actionError })] })), waitingForSlotChoice && (_jsxs("div", { style: s.waitingTurnPanel, children: [_jsx("div", { style: s.spinnerSm }), _jsxs("div", { children: [_jsxs("div", { style: { fontFamily: "var(--font-d)", fontSize: 14, fontWeight: 600, color: "var(--white)" }, children: [lr.winner === 1 ? gs.p1Name : gs.p2Name, " is choosing a lineup slot"] }), _jsx("div", { style: { fontSize: 12, color: "var(--white-dim)", marginTop: 2 }, children: "The roster updates as soon as they lock it in" })] })] })), (!lr.winner || lr.assignedSlot) && (_jsx("button", { style: s.nextBtn, onClick: handleAdvance, children: "Next player" }))] }))] })] }));
}
/* ─── Sub-components ─── */
