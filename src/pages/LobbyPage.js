...
export function LobbyPage() {
    ...
    return (_jsxs("div", { style: s.page, children: [_jsx("div", { style: s.mesh }), _jsxs("div", { style: s.wrap, children: [_jsxs("div", { style: s.header, children: [_jsx("div", { style: s.logoText, children: "Highest Bid" }), _jsx("div", { style: s.tagline, children: "NBA Draft Auction" })] }), _jsxs("div", { style: s.card, children: [_jsx("div", { style: s.cardLabel, children: "How it works" }), _jsx("div", { style: s.rules, children: [
                                ...
                                ].map((rule, i) => (_jsxs("div", { style: s.rule, children: [_jsx("span", { style: s.ruleN, children: String(i + 1).padStart(2, "0") }), _jsx("span", { style: s.ruleT, children: rule })] }, i))) })] }), _jsxs("div", { style: s.card, children: [_jsxs("div", { style: s.tabs, children: [_jsx("button", { style: { ...s.tab, ...(isCreate ? s.tabActive : {}) }, onClick: () => { setTab("create"); setError(""); }, children: "Create game" }), _jsx("button", { style: { ...s.tab, ...(!isCreate ? s.tabActive : {}) }, onClick: () => { setTab("join"); setError(""); }, children: "Join with code" })] }), isCreate ? (_jsxs("form", { onSubmit: handleCreate, style: s.form, children: [_jsx("label", { style: s.label, children: "Your name" }), _jsx("input", { style: s.input, placeholder: "Player 1", value: name, onChange: e => setName(e.target.value), maxLength: 20, autoFocus: true }), error && _jsx("div", { style: s.errMsg, children: error }), _jsx("button", { type: "submit", style: s.btnPrimary, disabled: loading, children: loading ? "Creating…" : "Create game" })] })) : (_jsxs("form", { onSubmit: handleJoin, style: s.form, children: [_jsx("label", { style: s.label, children: "Join code" }), _jsx("input", { style: { ...s.input, ...s.codeInput }, placeholder: "ABCXYZ", value: joinCode, onChange: e => setJoinCode(e.target.value.toUpperCase().slice(0, 6)), maxLength: 6, autoCapitalize: "characters", spellCheck: false, autoFocus: true }), _jsx("label", { style: s.label, children: "Your name" }), _jsx("input", { style: s.input, placeholder: "Player 2", value: name, onChange: e => setName(e.target.value), maxLength: 20 }), error && _jsx("div", { style: s.errMsg, children: error }), _jsx("button", { type: "submit", style: { ...s.btnPrimary, background: "var(--accent)" }, disabled: loading, children: loading ? "Joining…" : "Join game" })] }))] })] })] }));
}
const s = {
    page: {
    ...
    cardLabel: {
        ...
        color: "var(--white-dim)", textTransform: "uppercase", marginBottom: 14,
    },
