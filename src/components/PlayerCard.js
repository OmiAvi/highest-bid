...
export function PlayerCard({ player, animKey }) {
    ...
    return (_jsxs("div", { style: {
        ...
        }, children: [_jsx("div", { style: { height: 2, background: pc } }), _jsxs("div", { style: { padding: "18px 20px" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("span", { style: {
